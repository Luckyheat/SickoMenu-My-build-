...
#define JSON_TRYGET(key, value) \
        ...
        JSON_TRYGET("SilentLink", this->SilentLink);
        ...
        JSON_TRYGET("SMAC_CheckSilentLink", this->SMAC_CheckSilentLink);
        ...
        JSON_TRYGET("SMAC_Anti-Crash Protect", this->SMAC_CrashProtect);
    ...
    if (this->selectedConfig != "") {
        ...
        try {
            nlohmann::ordered_json j = nlohmann::ordered_json{
                ...
                { "SMAC_Anti-Crash Protect", this->SMAC_CrashProtect },
