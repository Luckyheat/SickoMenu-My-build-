...
public:
    ...
    bool ChatSpam = false;
    bool ChatOverloadSpam = false;
    bool Overflow = false;
    bool SecondOverflowIdk = false;
    bool Blackout = false;
    bool Blackout2 = false;
    bool Blackout3 = false;
    bool IPCheck = false;
    bool ATBEveryone = false;
    bool CrashChatSpam = false;
    bool ChatSpamEveryone = false;
    int ChatOverloadSpamMode = 1;
    int ChatSpamMode = 0;
    ...
    bool BanExploit1 = false;
    bool BanExploit2 = false;
    ...
    bool SMAC_CheckSilentLink = true;
