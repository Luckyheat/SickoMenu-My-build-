...
class RPCOPD : public RPCInterface {
	PlayerControl* Player;
	PlayerControl* target;
	int count;
	bool onlyOnTarget;
	bool exploit;
public:
	RPCOPD(PlayerControl* Player, PlayerControl* target, int count = 30, bool onlyOnTarget = true);
	virtual void Process() override;
};

class RPCOPDD : public RPCInterface {
	PlayerControl* Player;
	PlayerControl* target;
	int count;
	bool onlyOnTarget;
	bool exploit;
public:
	RPCOPDD(PlayerControl* Player, PlayerControl* target, int count = 30, bool onlyOnTarget = true);
	virtual void Process() override;
};

class RpcSendQuickChatNote : public RPCInterface {
	PlayerControl* Player;
	PlayerControl* target;
	int32_t type;
	std::string msg;
public:
	RpcSendQuickChatNote(PlayerControl* Player, PlayerControl* target);
	virtual void Process() override;
};

class RpcSpamQuickChatNote : public RPCInterface {
	PlayerControl* Player;
	PlayerControl* target;
	int32_t type;
	std::string msg;
public:
	RpcSpamQuickChatNote(PlayerControl* Player, PlayerControl* target);
	virtual void Process() override;
};

class Blackout : public RPCInterface {
	PlayerControl* Player;
	PlayerControl* target;
	int count;
	bool exploit;
public:
	Blackout(PlayerControl* Player, PlayerControl* target, int count = 30);
	virtual void Process() override;
};

class ATB : public RPCInterface {
	PlayerControl* Player;
	PlayerControl* target;
	int count;
	bool exploit;
public:
	ATB(PlayerControl* Player, PlayerControl* target, int count = 30);
	virtual void Process() override;
};
class NewExploit : public RPCInterface {
	PlayerControl* Player;
	PlayerControl* target;
	int count;
	bool exploit;
public:
	NewExploit(PlayerControl* Player, PlayerControl* target, int count = 30);
	virtual void Process() override;
};