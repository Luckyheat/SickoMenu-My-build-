...
#pragma region MessageWriter
    ...
    enum SendOption__Enum
    {
        ...
        SendOption__Enum_Hello = 0x08,
        SendOption__Enum_Disconnect = 0x09,
        SendOption__Enum_Acknowledgement = 0x0a,
        SendOption__Enum_Fragment = 0x0b,
        SendOption__Enum_Ping = 0x0c,
    };
